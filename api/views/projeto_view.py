...
@swagger_auto_schema(
    ...
    operation_description=(
        "Retorna uma visao geral dos projetos, com filtro opcional "
        "pelo parametro programa_id."
    ),
    responses={
        200: resposta_sucesso(
            "Visao geral dos custos acumulados por projeto ao longo do tempo.",
            schema_array(OVERVIEW_GRUPO_SCHEMA),
        ),
    },
)
@api_view(["GET"])
...
@swagger_auto_schema(
    ...
    operation_description=(
        "Retorna os projetos cadastrados com filtro textual opcional e "
        "filtro por programa."
    ),
    responses={
        200: resposta_sucesso(
            "Lista de projetos cadastrados.", schema_array(PROJETO_SCHEMA)
        ),
    },
)
@api_view(["GET"])
...
@swagger_auto_schema(
    ...
    operation_description=(
        "Retorna o resumo consolidado do projeto informado pelo identificador na URL."
    ),
    responses={
...
@swagger_auto_schema(
    ...
    operation_description=(
        "Retorna os materiais do projeto com suporte a paginacao e "
        "filtros por periodo e nome do material."
    ),
    responses={
        200: resposta_sucesso(
            "Lista paginada de materiais do projeto.",
            schema_paginada(MATERIAL_PROJETO_SCHEMA),
        ),
...
@swagger_auto_schema(
    ...
    operation_description=(
        "Retorna os materiais disponiveis para o projeto informado."
    ),
    responses={
        200: resposta_sucesso(
            "Lista de materiais disponiveis do projeto.",
            schema_array(MATERIAL_DISPONIVEL_SCHEMA),
        ),
