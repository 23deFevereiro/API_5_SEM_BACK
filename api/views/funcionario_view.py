...
@swagger_auto_schema(
    ...
    operation_description=(
        "Retorna os funcionarios associados a um projeto com suporte"
        " a paginacao e filtros por periodo e nome do funcionario."
    ),
    responses={
        200: resposta_sucesso(
            "Lista paginada de funcionarios do projeto.",
            schema_paginada(FUNCIONARIO_PROJETO_SCHEMA),
        ),
