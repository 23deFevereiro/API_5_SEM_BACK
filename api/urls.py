...
urlpatterns = [
    ...
    path(
        "api/compras/estoque-tabela/",
        compras_view.get_estoque_tabela_view,
        name="compras_estoque_tabela",
    ),
    path(
        "api/compras/sugestao-proxima-compra/",
        compras_view.get_sugestao_proxima_compra_view,
        name="compras_sugestao_proxima_compra",
    ),
]
